...
class BlogController {
    ...
    public function index() {
        ...
        $posts = [
            ...
            [
                'id' => 3,
                'title' => 'Success Story: From Graduate to Cloud Architect in 8 Months',
                'slug' => 'graduate-to-cloud-architect-success',
                'excerpt' => 'Read how Priya transformed her career from a computer science graduate to a successful cloud architect with R-CAT training.',
                'category_name' => 'Success Stories',
                'category_slug' => 'success-stories',
                'author_name' => 'R-CAT Team',
                'published_at' => '2025-07-05',
                'featured_image' => '/assets/images/blog/success-story.jpg'
            ]
        ];
